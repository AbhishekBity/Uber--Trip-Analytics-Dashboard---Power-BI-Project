# Uber-Ola-Trip-Analytics-Dashboard---Power-BI-Project
This project is an end-to-end Power BI dashboard analyzing Uber/Ola ride data. It provides insights into trip distribution, revenue, customer preferences, and time-based patterns.   
...
---
## 🎯 Objectives  
- Develop an interactive dashboard to monitor Uber/Ola rides.  
